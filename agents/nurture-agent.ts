...
Prompt 38 + **49** + **57** + **58**: 3 steps — **value-driven + creative**; at least one **pure generosity** touch; **different opening word** each step; varied channel; realistic spacing; tie to objections; **zero** filler recycled from qual/research; **zero** system/LLM/API leakage. **Prompt 49:** no **5+ word copy** from research exec/ICP/news, qual **bant_summary**, or **messaging_angles** — paraphrase into **fresh cadence**. **Prompt 57:** **warm_relationship_builder** → nurture must **build relationship** — helpful, **unscripted** rhythm; **never** "Day N: pitch" cadence. **Prompt 58:** each **content_asset_suggestion** = **named, specific artifact** for **this** account’s motion — no generic "case study" / "resource" alone.
